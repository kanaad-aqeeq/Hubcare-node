...
import { fetchOnboardingReport } from "../../../Redux-store/Slices/serviceReports/onboardingSlice";
const Data = [
  {
    date: "25/03/2025",
...
const Onboarding = () => {
  ...
  const { onboardingData } = useSelector((state) =>state.onboardingReport);



  useEffect(() =>{
    dispatch(fetchOnboardingReport());
  ...
  return (
    <>
      ...
      <CommanHeader title={"Onboarding Report"} />
      <div className="card">
            ...
            <table className="table table-row-dashed">
              <thead>
                <tr className="fw-bolder text-muted">
                  ...
                  <th className="w-175px text-center">Contact Phone</th>
                  <th className="w-150px text-center">Phone</th>
                ...
                {onboardingData.map((item, index) => {
                  return (
                    <tr key={index} className="">
                      ...
                      <td className="text-center">
                        <span className="">{item.contactPhone}</span>
                      </td>
                      <td className="text-center">
